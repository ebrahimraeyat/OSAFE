...
"""This module contains FreeCAD commands for the pyconcrete workbench"""
...
class PyconcreteWelcome:

    def GetResources(self):

        return {'Pixmap': os.path.join(os.path.dirname(__file__), "icons", "pyconcrete_Welcome.svg"),
                'MenuText': QT_TRANSLATE_NOOP("pyconcrete_Welcome", "pyconcrete Welcome screen"),
                'ToolTip': QT_TRANSLATE_NOOP("pyconcrete_Welcome", "Show the pyconcrete workbench welcome screen")}

    def Activated(self):

        # load dialog
        self.form = FreeCADGui.PySideUic.loadUi(os.path.join(os.path.dirname(__file__), "ui", "dialogWelcome.ui"))
    ...
    #         self.form.hide()
    #         FreeCADGui.runCommand("Pyconcrete_Tutorial")
