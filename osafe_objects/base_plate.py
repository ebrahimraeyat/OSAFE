...
class ViewProviderBasePlate:
    ...
    def getIcon(self):
        return str(Path(__file__).parent.parent / "osafe_images" / "base_plate.svg")
...
class CommandBasePlate:
    ...
    def GetResources(self):
        path = str(Path(__file__).parent.parent / "osafe_images" / "base_plate.svg")
    ...
    def taskbox(self):
        ...
        w = FreeCADGui.PySideUic.loadUi(str(punch_path / 'osafe_widgets' / 'base_plate.ui'))
